...
//        }
    ...
    public void updateUser(User user) {
        ...
        if (user.getLastName() != null && user.getLastName().length() > 0 && !userToUpdate.getLastName().equals(user.getLastName())) {
            userToUpdate.setLastName(user.getLastName());
        }
        if (user.getEmail() != null && user.getEmail().length() > 0 && !userToUpdate.getEmail().equals(user.getEmail()) && isValidEmail(user.getEmail())) {
            userToUpdate.setEmail(user.getEmail());
        }
        if (user.getPhoneNumber() != null && user.getPhoneNumber().length() > 0 && !userToUpdate.getPhoneNumber().equals(user.getPhoneNumber()) && user.getPhoneNumber().length() == 10){
            userToUpdate.setPhoneNumber(user.getPhoneNumber());
        }
        if (user.getRole() != null && user.getRole().length() > 0 && !userToUpdate.getRole().equals(user.getRole()) && ((user.getRole()=="ADMIN" || user.getRole()=="CUSOTMER" || user.getRole()=="TOP_LEVEL_MANAGER" || user.getRole()=="CAFE_MANAGER" || user.getRole()=="CASHIER" || user.getRole()=="KITCHEN_MANAGER" || user.getRole()=="WAITER" || user.getRole()=="DELIVERY_PERSON" || user.getRole()=="STOCKKEEPER"))) {
            userToUpdate.setRole(user.getRole());
        }
        if (user.getPassword() != null && user.getPassword().length() > 0 && !userToUpdate.getPassword().equals(user.getPassword())) {
            userToUpdate.setPassword(user.getPassword());
        }
        if (user.getAddress() != null && user.getAddress().length() > 0 && !userToUpdate.getAddress().equals(user.getAddress())) {
